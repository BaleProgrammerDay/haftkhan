...
const chatSlice = createSlice({
  ...
  reducers: {
	...
	deleteMessage(state, action: PayloadAction<{ chatId: Chats; messageId: string }>) {
	...
	changeChatState(state, action: PayloadAction<{ chatId: Chats; newState: ChatState }>) {
...
export const { setCurrentChat, deleteMessage, addMessage, changeChatState } = chatSlice.actions;
